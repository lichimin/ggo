...
type Scene struct {
	...
	Type        string  `json:"type" gorm:"size:50;default:'normal'"` // 场景类型
	Level       int     `json:"level" gorm:"default:1"`               //物品等级
	ImageURL    string  `json:"image_url" gorm:"size:500"`            // 场景图片
	Size        float64 `json:"size" gorm:"default:0.1"`              // 尺寸
	StopBullets bool    `json:"stop_bullets" gorm:"default:true"`     // 阻止子弹
